        ...
        "rounds": [
            {
                ...
                "challenger_exit_reason": r.get("challenger_exit_reason"),
                "challenger_error_summary": r.get("challenger_error_summary"),
                "challenger_error_details": r.get("challenger_error_details"),
                "challenger_agent_timeout_seconds": r.get("challenger_agent_timeout_seconds"),
